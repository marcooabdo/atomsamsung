...
DROP POLICY IF EXISTS "Usuários podem atualizar próprio perfil, masters podem atualizar todos" ON usuarios;
...
DROP POLICY IF EXISTS "Apenas gerentes e masters podem criar unidades" ON unidades;
DROP POLICY IF EXISTS "Apenas gerentes e masters podem atualizar unidades" ON unidades;
...
DROP POLICY IF EXISTS "Usuários autorizados podem criar cotações" ON cotacoes;
DROP POLICY IF EXISTS "Usuários autorizados podem atualizar cotações" ON cotacoes;
...
DROP POLICY IF EXISTS "Usuários podem ver lançamentos de sua unidade" ON financeiro_lancamentos;
DROP POLICY IF EXISTS "Financeiro e gerentes podem gerenciar lançamentos" ON financeiro_lancamentos;
...
DROP POLICY IF EXISTS "Todos podem ver serviços" ON servicos;
DROP POLICY IF EXISTS "Gerentes e masters podem gerenciar serviços" ON servicos;
...
DROP POLICY IF EXISTS "Usuários autenticados podem ver taxas" ON taxas_maquina;
DROP POLICY IF EXISTS "Usuários autenticados podem gerenciar taxas" ON taxas_maquina;
...
DROP POLICY IF EXISTS "Todos podem ver formas de pagamento" ON formas_pagamento;
DROP POLICY IF EXISTS "Gerentes e masters podem gerenciar formas de pagamento" ON formas_pagamento;
