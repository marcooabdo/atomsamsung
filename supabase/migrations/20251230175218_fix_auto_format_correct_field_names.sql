/*
  # Corrigir nomes dos campos na função de formatação

  1. Correção
    - Usa os nomes corretos dos campos da tabela OS
    - aparelho_imei, aparelho_numero_serie, aparelho_modelo
*/

-- Atualizar função com nomes corretos dos campos
