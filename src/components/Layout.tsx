...
const allMenuItems = [
  ...
  { id: 'chat', permKey: 'menu_chat', label: 'QG de Comunicação', icon: MessageSquare, path: '/chat' },
  ...
  { id: 'audit', permKey: 'menu_atom_audit', label: 'ATOM Audit', icon: ShieldCheck, path: '/audit', glow: true },
