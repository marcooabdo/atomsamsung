...
function ProgressBar({ percent }: { percent: number }) {
  const color =
    percent < 60 ? { bar: '#39FF14', shadow: 'rgba(57,255,20,0.5)', textColor: '#39FF14' }
    : percent < 85 ? { bar: '#FFBF00', shadow: 'rgba(255,191,0,0.5)', textColor: '#FFBF00' }
    : { bar: '#FF0064', shadow: 'rgba(255,0,100,0.5)', textColor: '#FF0064' };

  return (
    <div className="w-full">
      <div className="flex justify-between items-center mb-2">
        <span className="text-xs uppercase tracking-wider" style={{ color: 'var(--text-secondary)' }}>Consumo do Limite</span>
        <span className="text-sm font-bold" style={{ color: color.textColor }}>{percent.toFixed(1)}%</span>
      </div>
    ...
    <div className="space-y-6 fade-in">
      ...
      <div
        ...
        style={{
          ...
          boxShadow: '0 0 30px rgba(57,255,20,0.05), var(--card-shadow)',
        }}
      >
        {/* Title row */}
        <div className="flex items-center gap-3 mb-6">
          <div
            ...
            style={{ background: 'rgba(57,255,20,0.1)', border: '1px solid rgba(57,255,20,0.3)', boxShadow: '0 0 15px rgba(57,255,20,0.15)' }}
          >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          {[
            { label: 'Limite Total', value: data.limitTotal, color: '#00D4FF', dim: 'rgba(0,212,255,0.08)', dimBorder: 'rgba(0,212,255,0.25)' },
            { label: 'Crédito Consumido', value: data.consumido, color: data.percentual >= 85 ? '#FF0064' : data.percentual >= 60 ? '#FFBF00' : '#39FF14', dim: 'rgba(57,255,20,0.06)', dimBorder: 'rgba(57,255,20,0.2)' },
            { label: 'Crédito Livre', value: data.livre, color: '#39FF14', dim: 'rgba(57,255,20,0.06)', dimBorder: 'rgba(57,255,20,0.2)' },
          ].map(stat => (
            <div
              key={stat.label}
            ...
            return (
              ...
              >
                ...
                <p
                  ...
                  style={{ color: cfg.color, textShadow: `0 0 12px ${cfg.color}50` }}
                >
