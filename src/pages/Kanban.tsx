                            ...
                            {os.numero_os_samsung && (
                              <button
                                onClick={async (e) => {
                                  ...
                                  if (!unidadeData?.samsung_asccode || !unidadeData?.samsung_token) {
                                    alert('Unidade sem configuração Samsung');
                                    return;
                                  }
                                  ...
                                  try {
                                    ...
                                    if (text) text.textContent = 'SYNC GSPN';
                                    btn.disabled = false;
                                  }
                                }}
                                className="w-full mt-2 flex items-center justify-center gap-1.5 py-1.5 rounded-md text-[9px] font-bold transition-all"
                                style={{
                              ...
                              >
                                <RefreshCw className="w-3 h-3" style={{ filter: 'drop-shadow(0 0 4px #00D4FF)' }} />
                                <span>SYNC GSPN</span>
                              </button>
                            )}
                          </div>
